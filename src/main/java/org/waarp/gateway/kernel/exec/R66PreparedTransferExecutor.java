 ...
 * command will be refused for execution.
 ...
 * the last item:<br> "-to Host -file FILE
 * -rule RULE [-md5] [-nolog] [-start yyyyMMddHHmmss or -delay (delay or
 * +delay)] [-info INFO]" <br>
 * <br>
