...
public abstract class AbstractBusinessRequest implements Runnable {
    ...
    protected static String _INFO_ARGS =
            Messages.getString("AbstractBusinessRequest.0") + Messages.getString("Message.OutputFormat"); //$NON-NLS-1$
    ...
    protected static boolean getParams(String[] args) {
        ...
        logger.error(
                Messages.getString("AbstractBusinessRequest.NeedMoreArgs", "(-to -class)") + _INFO_ARGS); //$NON-NLS-1$
        return false;
    }
