 ...
 * Files will have to be separated by
...
public class MultipleSubmitTransfer extends SubmitTransfer {
   ...
   *     transfer, the rule, file transfer information as
   *     arguments and optionally isMD5=1 for true or 0 for false(default) and
   *     the blocksize if different than default
   */
      ...
      if (future.isSuccess()) {
        ...
        outputFormat
            .setValue(
                ...
                "Multiple " + Messages.getString("SubmitTransfer.3") +
        ...
        outputFormat
            .setValue(
                FIELDS.statusTxt.name(),
                "Multiple " + Messages.getString("SubmitTransfer.14") +
