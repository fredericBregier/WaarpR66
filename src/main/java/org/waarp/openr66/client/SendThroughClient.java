 ...
 * business project to implement how to read
 * new data to be sent to the remote host. If an error occurs, no transfer log
 * is kept.
 * <p>
 ...
 * following:<br> If the last block is not
 * empty:<br>
 * <tt>     DataBlock block = transaction.transformToDataBlock(data);</tt><br>
 ...
 * Don't forget at the very end to finish
