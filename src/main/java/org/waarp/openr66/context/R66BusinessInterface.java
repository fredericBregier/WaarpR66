...
public interface R66BusinessInterface {
    ...
    /**
     * Called to get the current extra "Information" from Business side to transmit, valid in extended protocol (> 2.4)
     *
     * @param session
     *
    ...
    /**
     * Set optional info to be set within extra information of PacketValid as "Info" or R66Result as "Other", valid in
     * extended protocol (> 2.4)
     *
     * @param session
     * @param info
     */
