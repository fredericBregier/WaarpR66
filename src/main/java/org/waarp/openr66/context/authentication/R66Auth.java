...
public class R66Auth extends FilesystemBasedAuthImpl {
  ...
  /**
   * Set the root relative Path from current status of Authentication (should be
   * the highest level for the current
   * authentication). If setBusinessRootFromAuth returns null, by default set
   * /user.
   *
   ...
   * specifically through ROLEs). Only "false
