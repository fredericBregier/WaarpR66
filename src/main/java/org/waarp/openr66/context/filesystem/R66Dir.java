...
public class R66Dir extends FilesystemBasedDirImpl {
   ...
   * but without checking BusinessPath, thus
   ...
   *     Those files are tested as valid from
   *     business point of view. If Wildcard support is not active, if the path
   *     contains any wildcards, it will throw an
   *     error.
   *
   * @throws CommandAbstractException
   */
