 ...
 * configuration):<br> - if delay is 0, only a warning
 * will be send with the message accordingly<br> - if delay is 1, a notification
 * with the current task and the current
