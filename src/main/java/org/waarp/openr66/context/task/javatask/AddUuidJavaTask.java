...
/**
 * Add an UUID in the TransferInformation to the current Task.</br> This should
 * be called on caller side in pre-task
 * since the transfer information will be transfered just after.</br> The
 * second
 * argument is -1 = added in front, +1 =
 * added at last, default being -1.</br> The third argument, optional, is
 * "-format" followed by a string containing
 * "#UUID#" to be replaced by the uuid and starting with - or +, meaning this
 * will be added at the beginning or the end
