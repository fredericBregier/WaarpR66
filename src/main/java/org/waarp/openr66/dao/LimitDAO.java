...
public interface LimitDAO {
    ...
    /**
     * Retrieve all Limit objects correspondig to the given filters in a List from the persistance layer
     *
    ...
    /**
     * Verify if a Limit object with the specified hostid exists in the persistance layer
     *
     * @param hostid Hostid of the Limit object verified
     *
     * @return true if a Limit object with the specified hostid exist; false if no Limit object correspond to the
     * specified hostid.
     *
     * @throws DAOException If a data access error occurs
     */
