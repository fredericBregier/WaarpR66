...
public interface MultipleMonitorDAO {
  ...
  /**
   * Retrieve all MultipleMonitor objects corresponding to the given filters in
  ...
  /**
   * Verify if a MultipleMonitor object with the specified hostid exists in the
   * persistance layer
   *
   ...
   *     false if no MultipleMonitor object
