...
public interface RuleDAO {
    ...
    /**
     * Retrieve all Rule objects corresponding to the given filters a List from the persistance layer
     *
    ...
    /**
     * Retrieve the Rule object with the specified Rulename from the persistance layer
     *
    ...
    /**
     * Verify if a Rule object with the specified Rulename exists in the persistance layer
     *
     * @param rulename rulename of the Rule object verified
     *
     * @return true if a Rule object with the specified Rulename exist; false if no Rule object correspond to the
     * specified Rulename.
     *
     * @throws DAOException If a data access error occurs
     */
