...
public class DbHostConfiguration extends AbstractDbData {
   ...
   */
  private static final ConcurrentHashMap<String, DbHostConfiguration>
  ...
  protected void setToArray() {
    ...
    allFields[Columns.UPDATEDINFO.ordinal()]
        .setValue(business.getUpdatedInfo());
  }
  ...
  public static String getVersionDb(String hostid) {
    ...
    if (others != null) {
      Element version = (Element) others
  ...
  /**
   * update Business with possible purge and new or added content, and updating
  ...
  /**
   * update Alias with possible purge and new or added content, and updating in
   * memory information
   *
   * @param config
   * @param newalias
  ...
  public void setAliases(String aliases) {
    ...
    do {
      ...
      this.business
          .setAliases(this.business.getAliases().replaceAll("\\s+", " "));
  ...
  public boolean isOwnConfiguration() {
    return this.business.getHostid()
  ...
  public boolean isSeeAllId(String id) {
    ...
    if (others != null) {
      Element seeallids = (Element) others
