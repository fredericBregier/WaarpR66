...
public class DbRule extends AbstractDbData {
  ...
  /**
   * Get Tasks from String. If it is not ok, then it sets the default values and
   * return new array of Tasks or null if
   * in error.
   *
   * @param tasks
   *
  ...
  public DbRule(String idrule, String[] idsArrayRef, int mode,
                ...
                String[][] spretasksArray, String[][] sposttasksArray,
