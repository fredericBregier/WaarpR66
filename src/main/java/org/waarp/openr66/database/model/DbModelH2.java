...
public class DbModelH2 extends org.waarp.common.database.model.DbModelH2 {
  ...
  public void createTables(DbSession session)
    ...
    System.out.println("Do UpdateVersionDb");
    DbHostConfiguration
        .updateVersionDb(Configuration.configuration.getHOST_ID(),
                         R66Versions.V2_4_25.getVersion());
    System.out.println("UpdateVersionDb done");
  }
    ...
    if (PartnerConfiguration
      ...
      try {
        ...
        request.select(
            ...
            DbTaskRunner.table +
            " where " + DbTaskRunner.Columns.SPECIALID + " = " +
