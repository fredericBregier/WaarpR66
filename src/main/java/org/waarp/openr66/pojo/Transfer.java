...
public class Transfer {
  ...
  /**
   * True if requester is the sender of the file (SEND MODE) False if requested
   * is the sender of the file (RETRIEVE
   * MODE)
   */
  ...
  public Transfer(long id, String rule, int mode, String filename,
                  ...
                  ErrorCode infoStatus, int rank, Timestamp start,
                  Timestamp stop,
  ...
  public Transfer(String remote, String rule, int ruleMode,
                  boolean retrieveMode, String file,
