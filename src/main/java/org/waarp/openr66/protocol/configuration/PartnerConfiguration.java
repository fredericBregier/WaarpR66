...
public class PartnerConfiguration {
  ...
  public PartnerConfiguration(String id, String json) {
    ...
    JsonHandler.setValue(root, FIELDS.DIGESTALGO,
                         Configuration.configuration.getDigest().getName());
   ...
   */
  public final static boolean isVersion2GEQVersion1(String version1,
                                                    String version2) {
    ...
    logger.debug("1: "
                 ...
                 +
                 (major1 < major2 ||
                  (major1 == major2 && (rank1 < rank2 || (rank1 == rank2 &&
                                                          subversion1 <=
                                                          subversion2)))));
   ...
   * @return True if version2 > version1
   */
  public final static boolean isVersion2GTVersion1(String version1,
                                                   String version2) {
    if (version1 == null || version2 == null) {
      return false;
    }
    ...
    return (major1 < major2 ||
            (major1 == major2 &&
             (rank1 < rank2 || (rank1 == rank2 && subversion1 < subversion2))));
  }
