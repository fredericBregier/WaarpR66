        ...
        if (taskRunner != null) {
          ...
          body = taskRunner
              .toSpecializedHtml(
                  ...
                  lcr != null? Messages.getString("HttpSslHandler.Active") :
                      Messages.getString(
                          "HttpSslHandler.NotActive")); //$NON-NLS-1$ //$NON-NLS-2$
  ...
  private static enum REQUEST {
    ...
    public String readBodyHeader() {
      return WaarpStringUtils.readFile(
          Configuration.configuration.getHttpBasePath() + this.headerBody);
    }

    public String readBody() {
      return WaarpStringUtils
          .readFile(Configuration.configuration.getHttpBasePath() + this.body);
    }

    public String readBodyEnd() {
      return WaarpStringUtils.readFile(
          Configuration.configuration.getHttpBasePath() + this.endBody);
    }

    public String readEnd() {
      return WaarpStringUtils
          .readFile(Configuration.configuration.getHttpBasePath() + this.end);
    }
  }
