  ...
  public void endParsingRequest(HttpRestHandler handler, RestArgument arguments,
    ...
    try {
      if (json instanceof InformationJsonPacket && method == METHOD.GET) {//
        ...
        R66Result r66result = serverHandler
  ...
  protected ArrayNode getDetailedAllow() {
    ...
    if (this.methods.contains(METHOD.PUT)) {
      ...
      try {
        ...
        ObjectNode node2 = RestArgument.fillDetailedAllow(METHOD.PUT, this.path,
                                                          ACTIONS_TYPE.StopOrCancelTransfer
                                                              .name(),
                                                          node5
                                                              .createObjectNode(),
                                                          node1);
    ...
    if (this.methods.contains(METHOD.POST)) {
      ...
      try {
        ...
        ObjectNode node2 =
            RestArgument.fillDetailedAllow(METHOD.POST, this.path,
