 ...
 * ShutdownOrBlockJsonPacket as PUT or no Json body but GET to get
  ...
  protected ArrayNode getDetailedAllow() {
    ...
    if (this.methods.contains(METHOD.PUT)) {
      ...
      try {
        ...
        node2 = RestArgument.fillDetailedAllow(METHOD.PUT, this.path,
    ...
    if (this.methods.contains(METHOD.GET)) {
      ...
      ObjectNode node2 = RestArgument.fillDetailedAllow(METHOD.GET, this.path,
                                                        ACTIONS_TYPE.GetStatus
                                                            .name(),
                                                        null, node1);
      node.add(node2);
    }

    ObjectNode node2 = RestArgument.fillDetailedAllow(METHOD.OPTIONS, this.path,
