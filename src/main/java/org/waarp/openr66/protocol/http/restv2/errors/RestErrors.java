 ...
 * input errors in an HTTP request made to the
 * REST API.
 */
public final class RestErrors {
  ...
  /**
   * Creates an error saying that one of the request's parameters has an illegal
   * value. This includes numbers out of
  ...
  /**
   * Creates an error saying that one of the JSON object's field is missing when
   * it was required. This error can also
   ...
   * value. This includes values of the
   ...
   * the same ID as the one in the entry the
   * user tried to create. Since the database cannot contain entries with
   * duplicate IDs, the requested entry cannot be
   * created.
   *
  ...
  /**
   * Creates an error saying that the transfer rule entered alongside the newly
   * created transfer does not exist.
   *
  ...
  /**
   * Creates an error saying that the requested host name entered alongside the
   * newly created transfer does not
   * exist.
   *
  ...
  /**
   * Creates an error saying that the given host is not allowed to use the given
   * rule for its transfers.
   *
