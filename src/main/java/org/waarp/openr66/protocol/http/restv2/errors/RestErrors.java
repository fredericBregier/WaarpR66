...
/**
 * Factory class used to create instances of {@link RestError} representing input errors in an HTTP request made to the
 * REST API.
 */
public final class RestErrors {
    ...
    /**
     * Creates an error saying that the request is missing a body when one was required.
     *
    ...
    /**
     * Creates an error saying that one of the request's parameters has an illegal value. This includes numbers out of
     * their expected range, or invalid enum values.
     *
    ...
    /**
     * Creates an error saying that the JSON object sent had an extra unknown field named with the given name.
     *
    ...
    /**
     * Creates an error saying that one of the JSON object's field is missing when it was required. This error can also
     * be sent if the field is present but is missing its' value.
     *
    ...
    /**
     * Creates an error saying that the given field has been assigned an illegal value. This includes values of the
     * wrong type, or values outside the allowed bounds of the field.
     *
    ...
    /**
     * Creates an error saying that the database already contains an entry with the same ID as the one in the entry the
     * user tried to create. Since the database cannot contain entries with duplicate IDs, the requested entry cannot be
     * created.
     *
    ...
    /**
     * Creates an error saying that the file requested for import at the given location does not exist on the server.
     *
    ...
    /**
     * Creates an error saying that the transfer rule entered alongside the newly created transfer does not exist.
     *
    ...
    /**
     * Creates an error saying that the requested host name entered alongside the newly created transfer does not
     * exist.
     *
    ...
    /**
     * Creates an error saying that the given host is not allowed to use the given rule for its transfers.
     *
    ...
    /**
     * Creates an error saying that the given field is a primary key, and thus cannot be changed when updating an
     * entry.
     *
