...
public class RestSignatureHandler
   ...
   * properly signed or not. If the signature is
   * valid, the request is forwarded to the corresponding {@link
   * AbstractRestDbHandler}, otherwise a reply is directly
   * sent stating that the request needs to be signed. If an unexpected error
   * occurs during the execution, an error
