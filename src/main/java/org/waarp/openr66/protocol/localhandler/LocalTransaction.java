...
public class LocalTransaction {
     ...
     */
    private final ConcurrentHashMap<String, LocalChannelReference> localChannelHashMapIdBased =
    ...
    public LocalTransaction() {
        ...
        serverBootstrap
                .childOption(ChannelOption.CONNECT_TIMEOUT_MILLIS, (int) Configuration.configuration.getTIMEOUTCON());
                ...
                if (localChannelReference != null) {
                    ...
                    if (step > 10000) {
                        ...
                        Configuration.configuration
                                .launchInFixedDelay(this, Configuration.WAITFORNETOP, TimeUnit.MILLISECONDS);
                    }
                }
            }
        }
