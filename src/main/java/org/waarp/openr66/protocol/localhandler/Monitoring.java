  ...
  public void initialize() {
    ...
    try {
      ...
      countInActiveTransfer =
          DbTaskRunner.getCountInOutRunningPrepareStatement(dbSession,
                                                            true, true);
      ...
      countOutErrorTransfer =
          DbTaskRunner.getCountInOutErrorPrepareStatement(dbSession,
                                                          false);
      ...
      if (dbSession == null || dbSession.isDisActive()) {
        ...
        try {
          ...
          if (detail) {
            ...
            DbTaskRunner
                .finishSelectOrCountPrepareStatement(countInitOkStep,
                                                     limitDate);
