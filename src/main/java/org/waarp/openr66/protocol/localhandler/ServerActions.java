...
public class ServerActions extends ConnectionActions {
    ...
    public final ConfigImportResponseJsonPacket configImport(ConfigImportJsonPacket json)
        ...
        boolean importedhost = false, importedrule = false, importedbusiness = false, importedalias = false,
                importedroles = false;
            ...
            try {
                ...
                if (sbusiness != null) {
                    try {
                        ...
                        logger.debug(
                                "Business configuration imported from " + sbusiness + "(" + importedbusiness + ")");
    ...
    public final String[] logPurge(boolean purge, boolean clean,
                                   Timestamp start, Timestamp stop, String startid, String stopid, String rule,
                                   String request,
    ...
    public final ValidPacket informationRequest(long id, boolean isTo, String remoteHost, boolean jsonOutput)
        ...
        if (isTo) {
            try {
                ...
                throw new OpenR66ProtocolNoDataException(Messages.getString("LocalServerHandler.22") + id,
                                                         e); //$NON-NLS-1$
            }
        } else {
            try {
