 ...
 * A Packet is composed of one Header part,
 * one Middle part (data), and one End part. Header: length field (4 bytes) =
 * Middle length field (4 bytes), End length
 * field (4 bytes), type field (1 byte), ...<br> Middle: (Middle length field
 * bytes)<br> End: (End length field bytes) =
