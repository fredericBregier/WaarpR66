...
public class ConfigImport implements Runnable {
  ...
  public static void main(String[] args) {
    ...
    try {
      ConfigImport transaction =
          new ConfigImport(future, shostpurge, srulepurge,
                           sbusinesspurge, saliaspurge, srolepurge, shost,
                           srule,
    ...
    try {
      ...
      future.setResult(new R66Result(
          new OpenR66ProtocolNoConnectionException(
              "Cannot connect to server " + dbhost.getHostid()),
