...
public class R66EmbeddedServiceImpl implements R66Service.Iface {
  ...
  private R66Result restart(R66Request request, LocalChannelReference lcr) {
    ...
    try {
      taskRunner = new DbTaskRunner(null, null,
                                    request.getTid(), request.getFromuid(),
                                    request.getDestuid());
      org.waarp.openr66.context.R66Result resulttest =
  ...
  private R66Result stopOrCancel(R66Request request, LocalChannelReference lcr,
    ...
    if (lcr != null) {
      ...
      int test = stopOrCancelRunner(request.getTid(), request.getDestuid(),
